...
const NoticeWrite = ({history}) => {
    ...
    const onclickSubmit = e => {
        ...
        if (a || b) {
            ...
            setIsMessageContents(b)
            axios
                .post(`https://server.pickle2020.site/notice/save`,
                    {
                        title: title,
                        password: password,
                        contents: contents,
                        category: select,
                        userTableId: localStorage.getItem("id")
                    },
                    {
            ...
            <CardBody>
                ...
                <form>
                    ...
                    <Row className="form-group">
                        ...
                        <div className="col-sm-10">
                            <input name="file" type="file" className="form-control-file"
                                   onChange={onChangeFile.bind(this)}/></div>
                    </Row>
                    <br/>
